...
namespace HexStrategy
{
    public static class Border
    {
        ...
        public static void Draw(Rectangle bounds, SpriteBatch sb)
        {
            ...
            sb.Draw(Textures.grey, new Rectangle(bounds.X - 2, bounds.Y - 2, 1, bounds.Height + 4), UserInterface.grey);

            //Left edge to right
            sb.Draw(Textures.darkGrey, new Rectangle(bounds.X - 1, bounds.Y - 1, bounds.Width + 2, 1), UserInterface.transparentBlack);
            sb.Draw(Textures.grey, new Rectangle(bounds.X - 2, bounds.Y - 2, bounds.Width + 4, 1), UserInterface.grey);
            ...
            sb.Draw(Textures.grey, new Rectangle(bounds.X - 2, bounds.Y + bounds.Height + 1, bounds.Width + 4, 1), UserInterface.grey);
            ...
            sb.Draw(Textures.grey, new Rectangle(bounds.X + bounds.Width + 1, bounds.Y - 2, 1, bounds.Height + 4), UserInterface.grey);
