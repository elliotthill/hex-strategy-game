...
namespace HexStrategy
{
	public class HexDetails
	{
		...
		public HexDetails()
		{
            ...
            textBounds.Add("wealth", new Vector2(bounds.X + UserInterface.textMargin, bounds.Y + (UserInterface.textSpacing * 4)));
		...
		public void Draw(SpriteBatch sb)
		{
			...
			if (Core.map.selectedHex != null) {
                ...
                sb.DrawString(Fonts.medium, "Wealth: " + Core.map.selectedHex.hexData.wealth.ToString(), textBounds["wealth"], Color.White);
